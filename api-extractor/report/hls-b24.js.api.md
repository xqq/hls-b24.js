## API Report File for "hls-b24.js"
...
export interface HlsListeners {
    ...
    // Warning: (ae-forgotten-export) The symbol "FragParsingPrivateData" needs to be exported by the entry point hls.d.ts
    //
    // (undocumented)
    [Events.FRAG_PARSING_PRIVATE_DATA]: (event: Events.FRAG_PARSING_PRIVATE_DATA, data: FragParsingPrivateData) => void;
    // (undocumented)

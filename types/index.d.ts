// Type definitions for hls.b24.js 0.12.3
// Project: https://github.com/xqq/hls.js
...
type K_FRAG_PARSING_PRIVATE_DATA = "hlsFragParsingPrivateData";
...
declare namespace Hls {
    ...
    interface fragParsingPrivateData {
        id: string;
        frag: Fragment;
        samples: any[];
    }
...
declare class Hls {
    ...
    static Events: {
        ...
        /**
         * fired when parsing PES packet private data is completed
         * data: { id : demuxer id, samples : [private data pes] }
         */
        FRAG_PARSING_PRIVATE_DATA: K_FRAG_PARSING_PRIVATE_DATA;
        /**
    ...
    on(event: K_FRAG_PARSING_PRIVATE_DATA, callback: (event: K_FRAG_PARSING_PRIVATE_DATA, data: Hls.fragParsingPrivateData) => void): void;
    ...
    once(event: K_FRAG_PARSING_PRIVATE_DATA, callback: (event: K_FRAG_PARSING_PRIVATE_DATA, data: Hls.fragParsingPrivateData) => void): void;
